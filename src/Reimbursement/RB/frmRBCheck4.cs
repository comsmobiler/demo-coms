    ...
    public partial class frmRBCheck4 : Smobiler.Core.MobileForm
    {
        ...
        private void Bind()
        {
            try
            {
                ...
                DataTable table = ReimbursementInfo.GetRBinfo4();
        ...
        /// <param name="e"></param>
        /// <remarks></remarks>
        private void frmRBCheck4_Load(object sender, EventArgs e)
        {
            try
            {
                Bind();
        ...
        /// <param name="e"></param>
        /// <remarks></remarks>
        private void frmRBCheck4_ToolbarItemClick(object sender, ToolbarClickEventArgs e)
        {
            try
            {
