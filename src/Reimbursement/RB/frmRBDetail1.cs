...
namespace COMSSmobilerDemo.Reimbursement.RB
{
    public partial class frmRBDetail1 : Smobiler.Core.MobileForm
    {
        ...
        /// <param name="e"></param>
        /// <remarks></remarks>
        private void frmRBDetail1_Load(object sender, EventArgs e)
        {
            try
            {
                Bind();
        ...
        private void frmRBDetail1_ToolbarItemClick(object sender, ToolbarClickEventArgs e)
        {
            try
            {
                if (e.Name.Equals(save.Name))
                {
                    frmRBConfirm frm = new frmRBConfirm();
