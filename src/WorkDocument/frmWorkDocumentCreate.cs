...
{
    partial class frmWorkDocumentCreate : Smobiler.Core.MobileForm
    {
        ...
        private void frmWorkDocumentCreate_Load(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmWorkDocumentCreate_ToolbarItemClick(object sender, ToolbarClickEventArgs e)
        {
            try
            {
